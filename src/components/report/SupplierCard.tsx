...
const SupplierCard: React.FC<SupplierCardProps> = ({ supplier }) => {
  return (
    <div className="p-4 border border-gray-300 bg-white rounded-md shadow-sm">
      <h3 className="mb-2 font-poppins-semibold text-base md:text-lg text-gray-800">
      ...
      <ul className="mb-4">
        <li>
          <strong className="text-gray-600">Pros:</strong>
        ...
        <li>
          <strong className="text-gray-600">Cons:</strong>
          <ul className="list-disc list-inside ml-4">
